...
```{r}
bio_comp_apps <- 
  mendeley_tags_cate_cleaned |> # Filter by applications
  ungroup() |> 
  filter(categories %in% "bioactive compounds") |> # Select bioactive compounds
...
microbio_trans_apps <- 
  mendeley_tags_cate_cleaned |> # Filter by applications
  ungroup() |> 
  filter(categories %in% "microbial transformation") |> # Select bioactive compounds
