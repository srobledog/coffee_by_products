...
by_products_citation_network <- 
  cocMatrix(data.frame(data_tidied), 
            Field = "CR", 
            sep = "; ")

by_products_citation_network_1 <- 
  graph_from_adjacency_matrix(by_products_citation_network,
                              mode = "directed")
...
# 3.3 Applications of Coffee by-products
